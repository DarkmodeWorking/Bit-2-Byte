...
const Footer = () => {
  return (
    <div className='flex flex-col items-center px-4 my-5 sm:my-10 py-6  text-white'>
      <div className='flex items-center space-x-4 mb-4'>
        <p className='text-xl sm:text-2xl font-medium'>Follow Us on our Socials</p>
        <a href='https://www.instagram.com/_bit_2_byte_' target='_blank' rel='noopener noreferrer'>
          <svg
            fill='#E4405F'
            className='h-8'
            role='img'
        ...
        <a href='https://www.linkedin.com/company/bit-2-byte' target='_blank' rel='noopener noreferrer'>
          <svg
            fill='#0A66C2'
            role='img'
            className='h-8 '
